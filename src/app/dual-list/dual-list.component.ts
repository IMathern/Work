...
import { DoCheck, EventEmitter, Input, IterableDiffers, OnChanges,
...
export class DualListComponent implements DoCheck, OnChanges {
	...
	static DEFAULT_FORMAT = { add: 'AJOUTER', remove: 'RETIRER', all: 'TOUS', none: 'AUCUN', direction: DualListComponent.LTR, draggable: true };
